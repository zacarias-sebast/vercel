...
import { Shield, AlertCircle, UserPlus, Eye, EyeOff, Mail, Lock, User, CheckCircle2 } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4" style={{ background: 'linear-gradient(135deg, #0b1120 0%, #0f1f3d 50%, #0b1120 100%)' }}>
      ...
      <style>{`
        ...
        .cad-card { animation: fadeUp 0.6s ease forwards; }
      ...
      <div className="cad-card" style={{ position: 'relative', zIndex: 1, width: '100%', maxWidth: '440px' }}>
        <div style={{
            ...
            {state?.success ? (
              ...
              <form action={formAction} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                ...
                <button type="submit" disabled={isPending} className="submit-btn" style={{ marginTop: '4px' }}>
                  {isPending
                    ? <><span style={{ width: 16, height: 16, border: '2px solid rgba(255,255,255,0.3)', borderTopColor: '#fff', borderRadius: '50%', display: 'inline-block', animation: 'spin 0.7s linear infinite' }} /> Cadastrando...</>
                    : <><UserPlus style={{ width: 16, height: 16 }} /> Criar Conta</>}
                </button>
              </form>
            )}
          </div>
