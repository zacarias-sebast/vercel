...
export default async function AdminLayout({
  ...
  // Se não há utilizador, apenas renderizar o conteúdo (para páginas públicas como login)
  if (!user) {
    return <>{children}</>
  }

  // Se há utilizador, mostrar interface com sidebar
  return (
          ...
          Novo Documento
            ...
            <div className="pt-4 mt-2 border-t border-gray-800">
              ...
              <div className="pt-4 mt-2 border-t border-gray-800">
                ...
                <Link href="/admin/governador" className="flex items-center gap-3 px-4 py-3 mt-2 text-gray-300 hover:bg-white/10 hover:text-white rounded-lg transition-colors">
                  <FileText className="w-5 h-5" />
                  Governador do Uíge
                </Link>
                <Link href="/admin/vice-governador" className="flex items-center gap-3 px-4 py-3 mt-1 text-gray-300 hover:bg-white/10 hover:text-white rounded-lg transition-colors">
                  <FileText className="w-5 h-5" />
                  Vice-Governador
                </Link>
              </div>
